...
at the same time and attempt to write to the same file. There is
still the chance a process could overwrite the record file of another
process with the same pid, but this should minimize the chance of
that happening.
